...
{
    public partial class ListaProfesorcs : Form
    {
        public ListaProfesorcs()
        {
            InitializeComponent();
        }

        private void ListaP_Enter(object sender, EventArgs e)
        {
            dataGridView1.AutoGenerateColumns = false;
            dataGridView1.DataSource = Class_dato.Profesores;
